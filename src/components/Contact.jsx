    ...
    return (
        <motion.div
            ...
            <motion.p
                ...
                transition={{ duration: 1 }}
                viewport={{ once: true }}
                className="2xl:mt-3 mt-1 2xl:text-sm xl:text-[12px] md:text-[11px] text-[10px] 2xl:p-2 xl:p-[8px] md:p-[5px] p-[2px]">Please contact me directly on <a className="underline" href="mailto:adinahmad003@gmail.com">adinahmad003@gmail.com</a> or through this form</motion.p>
            <motion.div
                initial={{ y: 100, opacity: 0 }}
                whileInView={{ y: 0, opacity: 1 }}
                transition={{ duration: 1 }}
                ...
                <motion.div
                    ...
                    transition={{ duration: 1 }}
                    viewport={{ once: true }}
                    className="flex justify-center 2xl:gap-20 xl:gap-15 md:gap-10 sm:gap-10 gap-7 w-[90%]">
